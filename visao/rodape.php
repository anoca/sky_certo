				...
				<div class="footer-widget-wrap">
					<div class="container">
						<div class="row section-gap">
							...
							<div class="col-lg-4  col-md-6 col-sm-6">
								<div class="single-footer-widget">
									<h4>Send e-mail for us</h4>
									<p>You can trust us. We want to know your opinions, tips and complaints, send us a message.</p>
									<div class="d-flex flex-row" id="mc_embed_signup">
										  ...
										  <form class="navbar-form" action="https://spondonit.us12.list-manage.com/subscribe/post?u=1462626880ade1ac87bd9c93a&amp;id=92a4423d01" method="get">
										    <div class="input-group add-on align-items-center d-flex">
										      	<form method="POST">
										      		<input class="form-control" name="EMAIL" placeholder="Your Message" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Your Message'" required="" type="email">
													<input type="submit">
												</form>
												<?php 
													$emails = $_POST["EMAIL"];
